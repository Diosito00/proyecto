    ...
    <div class="container-fluid px-4"> 
        ...
        <div class="collapse navbar-collapse" id="menuPrincipal">
            ...
            {{-- <ul>: Unordered List. Etiqueta para crear una lista de elementos.
                 ...
                 me-auto: ¡SÚPER IMPORTANTE! Significa Margin-End Auto. Pone todo el margen sobrante a la derecha de esta lista, empujando los botones de búsqueda y perfil hacia el extremo derecho de la pantalla. --}}
